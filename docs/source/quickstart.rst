...
.. code-block:: php
    ...
    class ExampleClass
    {
        ...
        public function updaetUser()
        {
            ...
            /*
            {
                "created_at": "2022-07-21T08:02:57.599Z",
                "email": "test@test.com",
                "email_verified": true,
                "identities": [
                    {
                        "user_id": "62d908310c0294bd8a60455ed",
                        "provider": "auth0",
                        "connection": "Username-Password-Authentication",
                        "isSocial": false
                    }
                ...
                "name": "test@test.com",
                "nickname": "Test",
                "picture": "https://s.gravatar.com/avatar/f8b33c4b3fe021ee5f45180f8620441d?s=480&r=pg&d=https%3A%2F%2Fcdn.auth0.com%2Favatars%2Fje.png",
                "updated_at": "2022-08-25T00:32:43.012Z",
                "user_id": "auth0|62d908310c0294bd8a60455ed",
                "last_ip": "222.127.137.66",
                "last_login": "2022-07-21T09:09:27.051Z",
                "logins_count": 3
            }
            */
            // You may retrieve each by calling and getResponse() method and chain with attribute
            // you want to retrieve
            $userId = $resource->getResponse()->user_id;
            $nickName = $resource->getResponse()->nickname;
...
.. code-block:: php
    ...
    class ExampleClass
    {
        ...
        public function updaetUser()
        {
            ...
            $resource->setHeaders(array(
                "Authorization" => sprintf("Bearer euy-34-9304")
            ));
